...
namespace Blessing.Gameplay.Characters
{
    public class CharacterMana : NetworkBehaviour
    {
        ...
        private void OnNetworkWhiteChanged(int previousValue, int newValue)
        {
            manaReserve.SetValue(ManaColor.White, newValue);
        }
        private void OnNetworkRedChanged(int previousValue, int newValue)
        {
            manaReserve.SetValue(ManaColor.Red, newValue);
        }
        private void OnNetworkGreenChanged(int previousValue, int newValue)
        {
            manaReserve.SetValue(ManaColor.Green, newValue);
        }
        private void OnNetworkBlueChanged(int previousValue, int newValue)
        {
            manaReserve.SetValue(ManaColor.Blue, newValue);
        }
        private void OnNetworkBlackChanged(int previousValue, int newValue)
        {
